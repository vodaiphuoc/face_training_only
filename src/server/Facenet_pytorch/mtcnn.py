...
class PNet(nn.Module):
    ...
    def __init__(self, state_dict_path:str, pretrained=True):
        super().__init__()
...
class MTCNN(nn.Module):
    ...
    def __init__(
        self, 
        p_state_dict_path:str,r_state_dict_path:str,o_state_dict_path:str,
        ...
        self.pnet = PNet(p_state_dict_path)
        self.rnet = RNet(r_state_dict_path)
        self.onet = ONet(o_state_dict_path)
    ...
    def forward(self, 
                img: List[np.ndarray], 
                save_path: Union[NoneType, List[str]] = None, 
                return_prob = True
